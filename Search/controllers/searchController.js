...
const getCityId = async (req, res) => {
    ...
    try {
      ...
      return res
        .status(500)
        .json({ err: true, message: "Something went wrong in city" });
    }
  }
};
...
const getCollection = async (req, res) => {
  ...
  if (!errors.isEmpty()) {
    ...
    try {
      ...
      return res
        .status(500)
        .json({ err: true, message: "Something went wrong in collections" });
    }
  }
};
...
const getLocalities = async (req, res) => {
  ...
  if (!errors.isEmpty()) {
    ...
    try {
      ...
      return res
        .status(500)
        .json({ err: true, message: "Something went wrong in localities" });
    }
  }
};
...
const getRestaurant = async (req, res) => {
  ...
  try {
    ...
    console.log(err);
    return res.status(500).json({ err: true, message: "Something went wrong in restaurant" });
  }
};
